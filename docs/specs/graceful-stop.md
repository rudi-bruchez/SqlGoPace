...
> `recordSkipped` (shared with the intent-based compression skip, `docs/specs/OPERATION-INTENT.md`).
...
| No signal handler (to be added for Ctrl+C) | `docs/specs/crash-resumable.md §3.1` |
| Operation cursor (sibling idea) + metadata skip | `docs/specs/crash-resumable.md §6, §9` |
