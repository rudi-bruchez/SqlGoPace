...
**Spec:** `docs/specs/superpowers/specs/2026-08-03-amplifying-maintenance-victim-design.md`. Read it before starting. Section references below (§1.2, §2.2, …) point into it.
...
- [ ] **Step 3: Record the engine semantics in docs/specs/SPECS.md**
...
```bash
git add README.md docs/specs/SPECS.md internal/version/VERSION
