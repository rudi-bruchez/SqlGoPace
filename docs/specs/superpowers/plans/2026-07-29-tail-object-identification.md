...
**Spec:** `docs/specs/superpowers/specs/2026-07-29-tail-object-identification-design.md`
...
- Consider adding a short note to `README.md` (manifest reference) and `docs/specs/SHRINK.md` documenting `identify_tail_object` and the `confirmed_by: tail_position` sidecar entries — the README is the canonical user-facing reference.
