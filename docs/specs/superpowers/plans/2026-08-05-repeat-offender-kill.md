...
**Design spec:** `docs/specs/superpowers/specs/2026-08-05-repeat-offender-kill-design.md` (read it first; the review that shaped it is `…-kimi.md`).
...
Note: `docs/specs/SPECS.md` does not document the blocker kill at all (`grep kill_blocking_sessions docs/specs/SPECS.md` returns nothing) — the feature is specified in `docs/specs/superpowers/specs/2026-07-22-blocker-roster-autokill-design.md`, which is a historical design record and is not retro-edited. There is nothing to change under `docs/specs/`.
