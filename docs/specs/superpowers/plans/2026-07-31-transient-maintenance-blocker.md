...
**Design source:** `docs/specs/superpowers/specs/2026-07-31-transient-maintenance-blocker-design.md` (revised per the Kimi assessment). Consult it for rationale.
...
- Tests alongside each; docs in `docs/specs/SHRINK.md` + `README.md`.
...
**Files:**
- Modify: `docs/specs/SHRINK.md` (add a "Concurrency with index maintenance" subsection)
...
Locate the insertion point: `grep -n "tail_position\|contended\|tail object" docs/specs/SHRINK.md` and add
...
```bash
git add docs/specs/SHRINK.md README.md internal/version/VERSION
