...
push** unless explicitly asked; English-only for Go code/comments/identifiers (specs/ may be
...
- `specs/crash-resumable.md` and `specs/graceful-stop.md`: note the identity-based RESUME and the
